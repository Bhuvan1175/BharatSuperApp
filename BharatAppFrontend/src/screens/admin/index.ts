/**
 * Super Admin surface — the SUPER_ADMIN experience.
 * Dashboard + the full management panel (users, departments, roles).
 */
export {default as AdminDashboardScreen} from './AdminDashboardScreen';
export {default as DepartmentUsersScreen} from './DepartmentUsersScreen';
